...
export const MIRROR_SITE_TAGLINE = 'Global Crisis Intelligence · Live Threat Matrix';
...
export function getEffectiveVariantMeta(variant: keyof typeof VARIANT_META = 'full'): VariantMeta {
  ...
  return {
    ...
    description: 'Global crisis intelligence dashboard — live threat matrix, breaking alerts, military tracking, markets, and geopolitical monitoring.',
  };
}