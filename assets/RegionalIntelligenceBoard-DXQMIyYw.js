var L=Object.defineProperty;var H=(e,r,i)=>r in e?L(e,r,{enumerable:!0,configurable:!0,writable:!0,value:i}):e[r]=i;var g=(e,r,i)=>H(e,typeof r!="symbol"?r+"":r,i);import{e as o,ig as C,p as z,r as j,a6 as E,aD as M,aW as D,aP as N,s as w,t as S,aL as O,aY as F}from"./panels-C7vyjkdk.js";import"./d3-DE1H7FhT.js";import"./i18n-qlunRAMb.js";const k=[{id:"mena",label:"Middle East & North Africa"},{id:"east-asia",label:"East Asia & Pacific"},{id:"europe",label:"Europe & Central Asia"},{id:"north-america",label:"North America"},{id:"south-asia",label:"South Asia"},{id:"latam",label:"Latin America & Caribbean"},{id:"sub-saharan-africa",label:"Sub-Saharan Africa"}],A="mena";function R(e,r){return e===r}function q(e){var r,i;return[W(e.narrative),U(e),_(e.balance),V(e.actors),G(e.scenarioSets),Z(e.transmissionPaths),Y(((r=e.triggers)==null?void 0:r.active)??[],((i=e.narrative)==null?void 0:i.watchItems)??[]),J(e)].join("")}function d(e,r,i=""){return`
  ...
  `}function W(e){if(!e)return"";const r=[h("Situation",e.situation),h("Balance Assessment",e.balanceAssessment),h("Outlook — 24h",e.outlook24h),h("Outlook — 7d",e.outlook7d),h("Outlook — 30d",e.outlook30d)].join("");return r?d("Narrative",r):""}function U(e){const r=e.regime,i=(r==null?void 0:r.label)??"unknown",t=(r==null?void 0:r.previousLabel)??"",n=(r==null?void 0:r.transitionDriver)??"",s=t&&t!==i?`<div style="font-size:11px;color:var(--text-dim);margin-top:2px">Was: ${o(t)}${n?` · ${o(n)}`:""}</div>`:"",c=`
  ...
  `;return d("Balance Vector",l)}function V(e){if(!e||e.length===0)return d("Actors",'<div style="font-size:11px;color:var(--text-dim)">No actor data</div>');const i=[...e].sort((t,n)=>(n.leverageScore??0)-(t.leverageScore??0)).slice(0,5).map(t=>{const n=t.delta>0?`+${t.delta.toFixed(2)}`:t.delta.toFixed(2),a=t.delta>0?"var(--danger)":t.delta<0?"var(--accent)":"var(--text-dim)",s=(t.leverageDomains??[]).slice(0,3).join(", ");return`
    ...
    `}).join("");return d("Transmission Paths",i)}function Y(e,r){const i=(e??[]).map(a=>`
  ...
  `}function Q(e){return e?new Date(e).toISOString().replace("T"," ").slice(0,16)+"Z":"—"}function X(e){if(!e||e.length===0)return d("Regime History",'<div style="font-size:11px;color:var(--text-dim)">No regime transitions recorded yet</div>');const r=e.slice(0,20).map(i=>{const t=i.previousLabel?o(i.previousLabel.replace(/_/g," ")):"none",n=o((i.label??"").replace(/_/g," ")),a=i.transitionDriver?` · ${o(i.transitionDriver)}`:"",s=Q(i.transitionedAt);return`
