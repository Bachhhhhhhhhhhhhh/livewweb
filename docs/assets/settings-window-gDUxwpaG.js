import{a as o,bS as h,bX as C,S as E,aa as r,ad as L,p as g,ab as u,dJ as T,s as w,t as S,e as p,a9 as b,ac as P,ae as k,af as $,ag as D,bD as _}from"./panels-C9SxPU8i.js";import{a as N}from"./user-location-Dbi7vwkd.js";import"./d3-DE1H7FhT.js";import"./i18n-qlunRAMb.js";function F(i,e){if(i==="runtime-config")return o("modals.runtimeConfig.title");const l=`panels.${i.replace(/-([a-z])/g,(m,c)=>c.toUpperCase())}`,d=o(l);return d===l?e:d}function U(){var c;const i=document.getElementById("app");if(!i)return;document.title=`${o("header.settings")} - ${N()}`;const e=h(E.panels,C),v=new Set(Object.keys(r));for(const s of Object.keys(e))!v.has(s)&&s!=="runtime-config"&&delete e[s];const l=new Set(L[g]??[]);for(const s of Object.keys(r))s in e||(e[s]={...u(s,g),enabled:l.has(s)});const d=T();function m(){const A=Object.entries(e).filter(([t])=>(t!=="runtime-config"||d)&&(!t.startsWith("cw-")||b())).map(([t,n])=>{const a=r[t]?u(t,g):n;return`
