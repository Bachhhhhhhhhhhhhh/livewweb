import{a as o,bR as C,bW as h,S as E,aa as r,ad as L,p as g,ab as u,dH as T,s as w,t as S,e as p,a9 as b,ac as P,ae as k,af as $,ag as _,bC as D}from"./panels-DEf_IK8a.js";import{a as H}from"./user-location-Dwkjkdx9.js";import"./d3-DE1H7FhT.js";import"./i18n-qlunRAMb.js";function N(i,e){if(i==="runtime-config")return o("modals.runtimeConfig.title");const l=`panels.${i.replace(/-([a-z])/g,(m,c)=>c.toUpperCase())}`,d=o(l);return d===l?e:d}function U(){var c;const i=document.getElementById("app");if(!i)return;document.title=`${o("header.settings")} - ${H()}`;const e=C(E.panels,h),v=new Set(Object.keys(r));for(const s of Object.keys(e))!v.has(s)&&s!=="runtime-config"&&delete e[s];const l=new Set(L[g]??[]);for(const s of Object.keys(r))s in e||(e[s]={...u(s,g),enabled:l.has(s)});const d=T();function m(){const A=Object.entries(e).filter(([t])=>(t!=="runtime-config"||d)&&(!t.startsWith("cw-")||b())).map(([t,n])=>{const a=r[t]?u(t,g):n;return`
