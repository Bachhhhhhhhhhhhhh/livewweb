var C=Object.defineProperty;var M=(t,r,i)=>r in t?C(t,r,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[r]=i;var g=(t,r,i)=>M(t,typeof r!="symbol"?r+"":r,i);import{e as o,ik as j,q as S,r as D,a8 as T,aG as N,aZ as O,aS as F,i as L,il as A,s as h,t as y,aO as q,a$ as W}from"./panels-DUFy1Muy.js";import"./d3-DE1H7FhT.js";import"./i18n-qlunRAMb.js";const k=[{id:"mena",label:"Middle East & North Africa"},{id:"east-asia",label:"East Asia & Pacific"},{id:"europe",label:"Europe & Central Asia"},{id:"north-america",label:"North America"},{id:"south-asia",label:"South Asia"},{id:"latam",label:"Latin America & Caribbean"},{id:"sub-saharan-africa",label:"Sub-Saharan Africa"}],P="mena";function R(t,r){return t===r}function U(t){var r,i;return[_(t.narrative),V(t),G(t.balance),Z(t.actors),K(t.scenarioSets),Q(t.transmissionPaths),X(((r=t.triggers)==null?void 0:r.active)??[],((i=t.narrative)==null?void 0:i.watchItems)??[]),Y(t)].join("")}function d(t,r,i=""){return`
  ...
  `}function _(t){if(!t)return"";const r=[b("Situation",t.situation),b("Balance Assessment",t.balanceAssessment),b("Outlook — 24h",t.outlook24h),b("Outlook — 7d",t.outlook7d),b("Outlook — 30d",t.outlook30d)].join("");return r?d("Narrative",r):""}function V(t){const r=t.regime,i=(r==null?void 0:r.label)??"unknown",e=(r==null?void 0:r.previousLabel)??"",n=(r==null?void 0:r.transitionDriver)??"",s=e&&e!==i?`<div style="font-size:11px;color:var(--text-dim);margin-top:2px">Was: ${o(e)}${n?` · ${o(n)}`:""}</div>`:"",p=`
    ...
    ${s}
  `;return d("Regime",p)}function x(t,r,i){const e=Math.max(0,Math.min(1,r))*100;return`
  ...
  `}function G(t){if(!t)return d("Balance Vector",'<div style="font-size:11px;color:var(--text-dim)">Unavailable</div>');const r=[x("Coercive",t.coercivePressure,"--danger"),x("Fragility",t.domesticFragility,"--danger"),x("Capital",t.capitalStress,"--danger"),x("Energy Vuln",t.energyVulnerability,"--danger")].join(""),i=[x("Alliance",t.allianceCohesion,"--accent"),x("Maritime",t.maritimeAccess,"--accent"),x("Energy Lev",t.energyLeverage,"--accent")].join(""),e=t.netBalance,n=Math.max(-1,Math.min(1,e)),a=Math.abs(n)*50,s=n>=0?"right":"left",p=n>=0?"var(--accent)":"var(--danger)",u=`
  ...
  `;return d("Balance Vector",l)}function Z(t){if(!t||t.length===0)return d("Actors",'<div style="font-size:11px;color:var(--text-dim)">No actor data</div>');const i=[...t].sort((e,n)=>(n.leverageScore??0)-(e.leverageScore??0)).slice(0,5).map(e=>{const n=e.delta>0?`+${e.delta.toFixed(2)}`:e.delta.toFixed(2),a=e.delta>0?"var(--danger)":e.delta<0?"var(--accent)":"var(--text-dim)",s=(e.leverageDomains??[]).slice(0,3).join(", ");return`
    ...
    `}).join(""),a=`<div style="display:grid;grid-template-columns:repeat(${i.length},1fr);gap:12px">${n}</div>`;return d("Scenarios",a)}function J(t){switch((t??"").toLowerCase()){case"critical":return"var(--danger)";case"high":return"var(--danger)";case"medium":return"var(--warning, #e0a020)";case"low":return"var(--text-dim)";default:return"var(--text-dim)"}}function Q(t){if(!t||t.length===0)return d("Transmission Paths",'<div style="font-size:11px;color:var(--text-dim)">No active transmissions</div>');const i=[...t].sort((e,n)=>(n.confidence??0)-(e.confidence??0)).slice(0,5).map(e=>{const n=J(e.severity),a=e.corridorId?` via ${o(e.corridorId)}`:"",s=Math.round((e.confidence??0)*100),p=e.latencyHours>0?` · ${e.latencyHours}h`:"";return`
  ...
  `}function tt(t){return t?new Date(t).toISOString().replace("T"," ").slice(0,16)+"Z":"—"}function et(t){if(!t||t.length===0)return d("Regime History",'<div style="font-size:11px;color:var(--text-dim)">No regime transitions recorded yet</div>');const r=t.slice(0,20).map(i=>{const e=i.previousLabel?o(i.previousLabel.replace(/_/g," ")):"none",n=o((i.label??"").replace(/_/g," ")),a=i.transitionDriver?` · ${o(i.transitionDriver)}`:"",s=tt(i.transitionedAt);return`
    ...
    `:""}
  `;return d("Weekly Brief",a)}const B=new F(q(),{fetch:W});class st extends j{constructor(){super({id:"regional-intelligence",title:"Regional Intelligence",infoTooltip:"Canonical regional intelligence brief: regime label, 7-axis balance vector, top actors, scenario lanes, transmission paths, and watchlist. One snapshot per region, refreshed every 6 hours.",premium:"locked"});g(this,"selector");g(this,"body");g(this,"currentRegion",P);g(this,"latestSequence",0);g(this,"lastHadPremium",!1);g(this,"authUnsubscribe",null);this.selector=S("select",{className:"rib-region-selector","aria-label":"Region"});for(const e of k){const n=document.createElement("option");n.value=e.id,n.textContent=e.label,e.id===P&&(n.selected=!0),this.selector.appendChild(n)}this.selector.addEventListener("change",()=>{this.currentRegion=this.selector.value,this.loadCurrent()});const i=S("div",{className:"rib-controls"},this.selector);this.body=S("div",{className:"rib-body"}),D(this.content,S("div",{className:"rib-shell"},i,this.body)),this.renderLoading(),this.lastHadPremium=T(),this.loadCurrent(),this.authUnsubscribe=N(()=>{const e=T();e&&!this.lastHadPremium?(this.lastHadPremium=!0,this.loadCurrent()):!e&&this.lastHadPremium&&(this.lastHadPremium=!1,this.renderEmpty())})}async loadRegion(i){this.currentRegion=i,this.selector.value=i,await this.loadCurrent()}destroy(){var i;(i=this.authUnsubscribe)==null||i.call(this),this.authUnsubscribe=null,this.latestSequence+=1,super.destroy()}async loadCurrent(){if(O){this.renderEmpty();return}if(!T()){this.renderEmpty();return}this.latestSequence+=1;const i=this.latestSequence,e=this.currentRegion;this.renderLoading();let n,a=e,s=null;try{const l=await B.getRegionalSnapshot({regionId:e});if(!R(i,this.latestSequence))return;n=l.snapshot}catch(l){if(!R(i,this.latestSequence))return;if(L()){const c=await A(e);if(c){h(this.body,y(c,"legacy direct innerHTML migration"));return}}this.renderError(l instanceof Error?l.message:String(l));return}if(!(n!=null&&n.regionId)){const l=k.map(m=>m.id).filter(m=>m!==e),c=4e3,v=await new Promise(m=>{if(l.length===0){m(null);return}let f=!1,$=l.length;const z=w=>{f||(f=!0,m(w))},I=setTimeout(()=>z(null),c);for(const w of l)B.getRegionalSnapshot({regionId:w}).then(E=>{var H;if((H=E.snapshot)!=null&&H.regionId){clearTimeout(I),z({snapshot:E.snapshot,id:w});return}--$===0&&(clearTimeout(I),z(null))}).catch(()=>{--$===0&&(clearTimeout(I),z(null))})});if(!R(i,this.latestSequence))return;v&&(n=v.snapshot,a=v.id,s=e)}if(!(n!=null&&n.regionId)){if(L()){const l=await A(e);if(l){h(this.body,y(l,"legacy direct innerHTML migration"));return}}this.renderEmpty();return}this.renderBoard(n,null,null,s);const p=B.getRegimeHistory({regionId:a,limit:20}).catch(()=>null),u=B.getRegionalBrief({regionId:a}).catch(()=>null);Promise.allSettled([p,u]).then(([l,c])=>{if(!R(i,this.latestSequence))return;const v=l.status==="fulfilled"?l.value:null,m=v&&!v.upstreamUnavailable?v.transitions??[]:null,f=c.status==="fulfilled"?c.value:null,$=f&&!f.upstreamUnavailable?f.brief:null;this.renderBoard(n,m,$,s)})}renderLoading(){h(this.body,y('<div class="rib-status" style="padding:16px;color:var(--text-dim);font-size:12px">Loading regional intelligence…</div>',"legacy direct innerHTML migration"))}renderEmpty(){h(this.body,y('<div class="rib-status" style="padding:16px;color:var(--text-dim);font-size:12px">Regional intelligence is being refreshed. Try selecting another region above.</div>',"legacy direct innerHTML migration"))}renderError(i){h(this.body,y(`<div class="rib-status rib-status-error" style="padding:16px;color:var(--danger);font-size:12px">We couldn't load this region right now: ${o(i)}</div>`,"legacy direct innerHTML migration"))}renderBoard(i,e,n,a){var p,u;let s="";if(a){const l=((p=k.find(v=>v.id===a))==null?void 0:p.label)??a,c=((u=k.find(v=>v.id===i.regionId))==null?void 0:u.label)??i.regionId;s+=`<div class="rib-fallback-notice" style="padding:10px 16px;margin:0 0 8px;background:var(--bg-elevated,rgba(255,255,255,0.04));border-left:3px solid var(--warning,#d4a015);font-size:12px;color:var(--text-dim);line-height:1.5">${o(l)} is being refreshed — showing ${o(c)} in the meantime.</div>`}s+=U(i),e!=null&&(s+=et(e)),n!==null&&(s+=it(n)),h(this.body,y(s,"legacy direct innerHTML migration"))}}export{st as RegionalIntelligenceBoard};
